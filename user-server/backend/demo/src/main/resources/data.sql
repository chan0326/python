# insert into boards (id, title,description ,reg_date, mod_date) values(1, "review","Financial Analyst", now(), now());
# insert into boards (id, title,description ,reg_date, mod_date) values(2, "qna","Media Manager II", now(), now());
